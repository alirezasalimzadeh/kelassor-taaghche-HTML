...
class PrintedBookAdmin(admin.ModelAdmin):
    ...
    fields = ['name', 'author', 'translator', 'collector', 'publisher', 'category', 'rate', 'volume', 'book_type',
              'price',
...
class AudioBookAdmin(admin.ModelAdmin):
    list_display = ('name', 'category', 'rate')
    search_fields = ('category',)
    fields = ['name', 'author','speaker',  'translator', 'category', 'rate', 'volume', 'book_type', 'price',
